...
class ResourceRequestSerializer(serializers.ModelSerializer):
    ...
    origin_facility_object = FacilityBasicInfoSerializer(source="origin_facility", read_only=True, required=False)
    ...
    origin_facility = serializers.UUIDField(source="origin_facility.external_id", allow_null=False, required=True)
    ...
    def create(self, validated_data):
        ...
        origin_facility_external_id = validated_data.pop("origin_facility")["external_id"]
        validated_data["origin_facility_id"] = Facility.objects.get(external_id=origin_facility_external_id).id
